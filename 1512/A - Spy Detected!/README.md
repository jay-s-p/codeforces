...
3
20 20 10
</pre></div><div class="output"><div class="title">Output<div title="Copy" data-clipboard-target="#id00752589131840214" id="id009034102834303024" class="input-output-copier">Copy</div></div><pre id="id00752589131840214">2
1
5
3
</pre></div></div></div>